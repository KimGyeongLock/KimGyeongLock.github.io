...
* 방사형 그래디언트
    ...
    ```
    > <img width="228" alt="스크린샷 2022-06-08 오후 12 42 32" src="https://user-images.githubusercontent.com/63464299/172530868-73b86e72-b995-433d-8426-bfaa60f2209c.png">
* 원뿔형 그래디언트
    ```
    Circle()
        .fill(AngularGradient(gradient: colors, center: .center))
    ```
    > <img width="228" alt="스크린샷 2022-06-08 오후 12 44 03" src="https://user-images.githubusercontent.com/63464299/172530875-370d5b45-109d-408b-895a-356fcd1a9edc.png">
* 선형 그래디언트
    ```
    Rectangle()
