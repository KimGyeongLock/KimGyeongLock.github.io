---
layout: single
title: "[Spring] 또 OAuth2.0, JWT 로그인,, 근데 이제 Redis를 곁들인 (1)"
toc: true
toc_sticky: true
categories: tradeham
---
...
[https://claude.ai/chat/d996c61d-b0be-4599-bd17-00226fa4ab0d](https://claude.ai/chat/d996c61d-b0be-4599-bd17-00226fa4ab0d)
...
- **재로그인 무한 루프 오류**의 발생 가능성의 위험성이 있기 때문에 수정
    ...
    [스프링 OAuth2 클라이언트 JWT 17 : 재로그인 무한 루프 오류](https://www.youtube.com/watch?v=OCssYnZbLOU&list=PLJkjrxxiBSFALedMwcqDw_BPaJ3qqbWeB&index=17)
